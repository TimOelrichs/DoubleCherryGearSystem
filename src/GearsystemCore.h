...
public:
    ...
    bool RunStep(u8* pFrameBuffer, s16* pSampleBuffer, int* pSampleCount, bool step = false, bool stopOnBreakpoints = false);
    ...
    void SetGearToGearTarget(GearsystemCore* target);
